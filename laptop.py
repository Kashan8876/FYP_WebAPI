...
def main():
    ...
    Symptom11 = request.form.get('Symptom11')
    Symptom12 = request.form.get('Symptom12')
    Symptom13 = request.form.get('Symptom13')
    Symptom14 = request.form.get('Symptom14')
    Symptom15= request.form.get('Symptom15')
